...
open class UtilityAndroidUnitTestHelper {
    ...
    protected fun application(): Application {
        if (applicationMock == null) {
            ...
            every { applicationMock!!.getSystemService(VibratorManager::class.java) } returns mockk<VibratorManager>(
                relaxed = true
            )

            val sharedPreferencesMock = mockk<SharedPreferences>(relaxed = true)
