...
class RepositoryBag private constructor(private val context: Context) :
    RepositoryBagInterface {
    companion object {
        @SuppressLint("StaticFieldLeak")
        private var instance: RepositoryBag? = null

        fun getInstance(context: Context): RepositoryBag {
            if (instance == null) {
                instance = RepositoryBag(context)
            }
            return instance!!
        }
    }
                ...
                diceBagProtocolBuffer.diceList.forEach { diceProtocolBuffer ->
                    diceBag.add(
                        Dice(
                            ...
                            titleStringsId = diceProtocolBuffer.titleStringsId,
                            colour = diceProtocolBuffer.colour,
                            selected = diceProtocolBuffer.selected,
                            multiplier = diceProtocolBuffer.multiplier,
        ...
        diceProtocolBuffer.sideList.forEach { sideProtocolBuffer ->
            ...
            sides.add(
                Side(
                    ...
                    descriptionStringsId = sideProtocolBuffer.descriptionStringsId,
