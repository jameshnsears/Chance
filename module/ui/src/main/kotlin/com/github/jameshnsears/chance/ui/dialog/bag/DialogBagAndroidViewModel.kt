...
class DialogBagAndroidViewModel(
    ...
    val cardSideAndroidViewModel = CardSideAndroidViewModel(
        application,
        side
    )

    val cardDiceViewModel = CardDiceViewModel(
        repositoryBag,
        dice
    )

    val cardRollViewModel = CardRollViewModel(
        dice
    )

    val selectedTabIndex: MutableState<Int> = mutableIntStateOf(1)
