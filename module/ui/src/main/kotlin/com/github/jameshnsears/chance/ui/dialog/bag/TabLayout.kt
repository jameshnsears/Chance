...
fun
    ...
    Column {
        PrimaryTabRow(selectedTabIndex = dialogBagAndroidViewModel.selectedTabIndex.value) {
            tabs.forEachIndexed { index, tab ->
                Tab(
                    selected = dialogBagAndroidViewModel.selectedTabIndex.value == index,
                    onClick = { dialogBagAndroidViewModel.selectedTabIndex.value = index },
                    icon = {
                        Icon(
        ...
        DialogBagTabContent(
            ...
            selectedTabIndex = dialogBagAndroidViewModel.selectedTabIndex.value,
            showDialog,
        )
    }
}
