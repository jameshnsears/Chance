...
fun SideDescription(
    ...
    OutlinedTextField(
        ...
        onValueChange = {
            if (it.length <= 25) {
                cardSideService.sideDescription(it)
            }
        },
        label = { Text(stringResource(R.string.dialog_bag_side_description)) },
        supportingText = {
            Text(
                text = "${sideDescription.length} / 25",
        ...
        singleLine = true,
        modifier = Modifier
            .testTag(CardFaceTestTag.SIDE_DESCRIPTION)
...
@Composable
fun SideDescriptionColour(cardSideService: CardSideService) {
    ...
    Row(
        ...
        Button(
            ...
            modifier = Modifier
                ...
                .testTag(CardFaceTestTag.SIDE_DESCRIPTION_COLOUR),
            enabled = !diceSidesFewerThanSdeNumber
        ) {
            Icon(
    ...
    if (showDialogColourPicker.value) {
        DialogColourPicker(
            ...
            descriptionColour,
            cardSideService::sideDescriptionColour,
        )
    }
}
