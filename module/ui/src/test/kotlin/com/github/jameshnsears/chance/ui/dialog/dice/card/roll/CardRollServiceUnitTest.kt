...
class CardRollServiceUnitTest : DialogDiceUnitTestUnitTestHelper() {
    @Test
    ...
    private fun cardRollViewModelCardRollStatePair(dialogDiceAndroidViewModel: DialogDiceAndroidViewModel):
        Pair<CardRollService, CardRollState> {
        return Pair(
    ...
    private fun getDialogBagAndroidViewModel(dice: Dice): Pair<Dice, DialogDiceAndroidViewModel> {
